...
sms_backend API
- API version: 1.0.0
  - Build date: 2023-04-08T17:43:06.709230100+01:00[Africa/Luanda]
...
------------ | ------------- | ------------- | -------------
*DefaultApi* | [**admitStudent**](docs/DefaultApi.md#admitStudent) | **POST** /api/admission/admit | POST api/admission/admit
